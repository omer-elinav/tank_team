...
function main() {
    ...
    let speed_gauge = new Gauge(
        ...
        5,
        gauge_size,
        PIXI.Texture.from('assets/speed/speed.png')
    );
    ...
    handle_speed.events.up = () =>{
        speed_gauge.step_up();
    }
    handle_speed.events.down = () =>{
        speed_gauge.step_down();
    }
